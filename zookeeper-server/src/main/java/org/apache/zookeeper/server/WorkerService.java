 ...
 * ExecutorService.
 * <ul>
 * <li>NIOServerCnxnFactory uses a non-assignable WorkerService because the
 * socket IO requests are order independent and allowing the
 * ExecutorService to handle thread assignment gives optimal performance.</li>
 * <li>CommitProcessor uses an assignable WorkerService because requests for
 * a given session must be processed in order.</li>
 * </ul>
...
public class WorkerService {
    ...
    /**
     * @param name worker threads are named {@code <name>Thread-##}
    ...
    public abstract static class WorkRequest {
         ...
         *
         * <p>The generic {@code throws Exception} is intentionally preserved for
         * source compatibility with existing WorkRequest implementations that may
         * currently declare or throw checked exceptions.</p>
         */
