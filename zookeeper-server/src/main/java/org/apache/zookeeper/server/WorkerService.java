 ...
 * socket IO requests are order independent and allowing the ExecutorService
 * to handle thread assignment gives optimal performance.
 * <p>
...
public class WorkerService {
    ...
    public abstract static class WorkRequest {
         ...
         *
         * <p>The broad {@code Exception} declaration is intentionally preserved:
         * existing subclasses may override this method with checked exceptions
         * such as {@code InterruptedException} or other checked {@code Exception}
         * types. Narrowing it would break source compatibility with those
         * implementations.</p>
         */
